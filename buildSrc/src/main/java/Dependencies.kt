object Dependencies {
    ...
    private const val retrofitInterceptor = "com.squareup.okhttp3:logging-interceptor:${Versions.retrofitInterceptorVersion}"
    val networkLibraries = listOf(retrofit, retrofitConverter, retrofitMoshi, retrofitInterceptor)
